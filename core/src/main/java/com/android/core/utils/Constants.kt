...
object Constants {
    ...
    const val DB_TABLE_PRODUCTS = "products"
    const val DB_COLUMN_MAIN_ID = "main_id"
    const val DB_COLUMN_DETAILS_ID = "details_id"
    const val TAG_DIALOG_FILTER = "filterOptions"
    const val KEY_DIALOG_FILTER = "filterOptions"
